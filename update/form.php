...
<body> 
    <?php 
        ...
        <div class="input-container mt-30">
            <input id="nama_lengkap" class="input" type="text" name="nama_lengkap" value="<?php echo $data['nama'] ?>" required>
            <div class=" cut">
            </div>
            <label for="namalengkap" class="placeholder">Nama Lengkap</label>
        </div>
        <div class="input-container mt-30">
            <input id="kelas" class="input" type="text" name="kelas"  value="<?php echo $data['kelas'] ?>" required>
            <div class="cut"></div>
            <label for="kelas" class="placeholder">Kelas</label>
        </div>
        <div class="input-container mt-30">
            <input id="jurusan" class="input" type="text" name="jurusan" value="<?php echo $data['jurusan'] ?>" required>
            <div class="cut"></div>
